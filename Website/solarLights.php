...
$subcat = "ourProducts/solarLights/Solar Lights";

$modelslist = scandir($subcat);
		
echo('<article  id="'.$subcat.'style="margin-top: 0px;">

	<h3 style="padding: 13px; background-color: #d11237; color: #fff;" align="center">Solar Lights</h3>
				...
				<div class="modal-content">
					...
					if($content[0] == "continue"){
						echo('<tr style="border-bottom: 1px solid #d11237;">
							<td class="desc_table" style="padding: 10px; margin: 20px; "></td>
