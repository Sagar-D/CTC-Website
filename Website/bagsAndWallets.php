...
$subcat = "ourProducts/corporateGifts/Bags And Wallets/Gents Wallet";

$modelslist = scandir($subcat);
		
echo('<article  id="'.$subcat.'style="margin-top: 0px;">

	<h3 style="padding: 13px; background-color: #d11237; color: #fff;" align="center">Mens Wallet</h3>
...
$subcat = "ourProducts/corporateGifts/Bags And Wallets/Ladies Wallet";

$modelslist = scandir($subcat);
		
echo('<article  id="'.$subcat.'style="margin-top: 0px;">

	<h3 style="padding: 13px; background-color: #d11237; color: #fff;" align="center">Ladies Wallet</h3>
	...
	<div class="row">');
		...
		foreach($modelslist as $model){
			...
			if($model == "." || $model == ".."){
				...
				echo('<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-2">
				<div class="card" style="margin:0px; margin-bottom: 50px;  padding: 10px; ">
...
$subcat = "ourProducts/corporateGifts/Bags And Wallets/Travel Kit";

$modelslist = scandir($subcat);
		
echo('<article  id="'.$subcat.'style="margin-top: 0px;">

	<h3 style="padding: 13px; background-color: #d11237; color: #fff;" align="center">Travel Kit</h3>
