...
$subcat = "ourProducts/customizedClocks/Wall cum Table Clocks";

$modelslist = scandir($subcat);
		
echo('<article  id="'.$subcat.'style="margin-top: 0px;">

	<h3 style="padding: 13px; background-color: #d11237; color: #fff;" align="center">Wall-cum-Table Clocks</h3>
